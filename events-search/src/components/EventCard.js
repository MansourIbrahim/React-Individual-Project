    ...
    <div className="event-card">
      <div className="text-img-container">
        <div className="text-container">
          ...
          <p>
            <span>{props.classifications[0].segment.name}</span> &nbsp;
      ...
      <div className="save-btn-container">
        {isMyEvent ? (
          <button onClick={deleteEvent} id={props.id}>
            Delete
          </button>
        ) : (
          <button onClick={saveEvent} id={props.id}>
            <img
              onClick={saveEvent}
              id={props.id}
              src="https://cdn2.iconfinder.com/data/icons/instagram-ui/48/jee-67-512.png"
              alt="My Events"
            />
            Save
          </button>
        ...
        <button id={props.id}>
          <img
            src="https://cdn2.iconfinder.com/data/icons/facebook-ui/48/Jee-18-512.png"
            alt="share"
          />
          Share
        </button>
